...
def build_final_text(jr_atasan: str, jr_last: str) -> str:
    # Default final_text sama dengan jr_atasan
    final_text = jr_atasan

    # Jika jr_last ada isinya, tambahkan warning
    ...
    # Cleaning teks
    final_text = re.sub(r"\n+", ". ", final_text)   # newline jadi ". "
    final_text = re.sub(r"\s+", " ", final_text)    # spasi berlebih
    final_text = re.sub(r"\. \.", ".", final_text)  # titik dobel
    final_text = final_text.strip()
    final_text = final_text.replace("'", "")        # hapus apostrof
